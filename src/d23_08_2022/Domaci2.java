...
//		Naravno u glavnom kreirati objekte i testirati funkcionalnosti 
		...
		Racun djoka = new Racun("242-35645-234", "Djordje Karaklajic", 100);
		Racun raka = new Racun("213-23424-345", "Raka Djuric", 20);
		
		djoka.stampaj();
		raka.stampaj();
		
		Transakcija transakcija = new Transakcija("123", djoka, raka);

		transakcija.izvrsiTransakciju(50);
		transakcija.stampaj();
